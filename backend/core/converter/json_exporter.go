...
//
// Parameters:
//   - data: Slice of NameDescriptionData structures to export
//   - fileName: Name of the JSON file to create
//
// Returns: error if file creation fails
func createNameDescriptionJSON(data []*NameDescriptionData, fileName string) error {
...
func serializeNameDescriptionToJSON(objects components.IList[components.ILocalizedTextObject], jsonFileName string) error {
	...
	objects.ForIndex(func(i int, nameDescObj components.ILocalizedTextObject) {
		if nameDescObj == nil {
...
func serializeNameOnlyToJSON(objects components.IList[components.ILocalizedTextObject], jsonFileName string) error {
	...
	objects.ForIndex(func(i int, nameObj components.ILocalizedTextObject) {
		if nameObj == nil {
			common.LogVerbose("Object %d is nil, skipping", i)
			return
		}
...
// ExportKeyItemsToJSON exports key items data from components.KEY_ITEMS to a JSON file.
//
...
func ExportKeyItemsToJSON() error {
	...
	return serializeNameDescriptionToJSON(components.KEY_ITEMS, "key_items_all_localizations.json")
}

// ExportCommandsToJSON exports commands data from components.COMMANDS to a JSON file.
//
...
func ExportCommandsToJSON() error {
	...
	return serializeNameDescriptionToJSON(components.COMMANDS, "commands_all_localizations.json")
}

// ExportItemsToJSON exports items data from components.ITEMS to a JSON file.
//
...
func ExportItemsToJSON() error {
	...
	return serializeNameDescriptionToJSON(components.ITEMS, "items_all_localizations.json")
}

// ExportArmsToJSON exports arms data from components.ARMS_TEXT to a JSON file.
//
...
func ExportArmsToJSON() error {
	...
	return serializeNameDescriptionToJSON(components.ARMS_TEXT, "arms_all_localizations.json")
}

// ExportConfigToJSON exports config data from components.CONFIG_TEXT to a JSON file.
//
...
func ExportConfigToJSON() error {
	...
	return serializeNameDescriptionToJSON(components.CONFIG_TEXT, "config_text_all_localizations.json")
}

// ExportItemCommandsToJSON exports item descriptions from components.ITEM_TEXT to a JSON file.
//
...
func ExportItemCommandsToJSON() error {
	...
	return serializeNameDescriptionToJSON(components.ITEM_TEXT, "item_commands_all_localizations.json")
}

// ExportMainMenuToJSON exports main menu data from components.MMAIN_TEXT to a JSON file.
//
...
func ExportMainMenuToJSON() error {
	...
	return serializeNameDescriptionToJSON(components.MMAIN_TEXT, "main_menu_all_localizations.json")
}

// ExportPlayerRoomToJSON exports player room data from components.PLAYER_ROOM to a JSON file.
//
...
func ExportPlayerRoomToJSON() error {
	...
	return serializeNameDescriptionToJSON(components.PLAYER_ROOM, "player_room_all_localizations.json")
}

// ExportBuildToJSON exports build data from components.BUILD_TEXT to a JSON file.
//
...
func ExportBuildToJSON() error {
	...
	return serializeNameOnlyToJSON(components.BUILD_TEXT, "build_all_localizations.json")
}

// ExportBattleToJSON exports battle data from components.BTL_TEXT to a JSON file.
//
...
func ExportBattleToJSON() error {
	...
	return serializeNameOnlyToJSON(components.BTL_TEXT, "battle_text_all_localizations.json")
}

// ExportBattleEndToJSON exports battle end data from components.BTLEND_TEXT to a JSON file.
//
...
func ExportBattleEndToJSON() error {
	...
	return serializeNameOnlyToJSON(components.BTLEND_TEXT, "battle_end_text_all_localizations.json")
}

// ExportMonsterMagic1ToJSON exports monster magic 1 data from components.MONMAGIC1 to a JSON file.
//
...
func ExportMonsterMagic1ToJSON() error {
	...
	return serializeNameOnlyToJSON(components.MONMAGIC1, "monster_magic1_all_localizations.json")
}

// ExportMonsterMagic2ToJSON exports monster magic 2 data from components.MONMAGIC2 to a JSON file.
//
...
func ExportMonsterMagic2ToJSON() error {
	...
	return serializeNameOnlyToJSON(components.MONMAGIC2, "monster_magic2_all_localizations.json")
}

// ExportNameToJSON exports name data from components.NAME_TEXT to a JSON file.
//
...
func ExportNameToJSON() error {
	...
	return serializeNameOnlyToJSON(components.NAME_TEXT, "names_all_localizations.json")
}
...
// getSortedEventIDs returns all event IDs sorted alphabetically
