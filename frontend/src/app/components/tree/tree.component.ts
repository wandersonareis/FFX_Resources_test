...
export class FfxTreeComponent implements OnInit {
  private readonly _ffxContextMenuService: FfxContextMenuService = inject(
    FfxContextMenuService
  );
